...
export async function fetchCars(filters: FilterProps) {
  ...
  const headers = {
    'X-RapidAPI-Key': '7453086c29mshf78934281f9b91bp1811efjsnccc3de36b6b5',
...
export function mpgToLper100km(mpg: number) {
  if (mpg <= 0) {
    return 'MPG must be greater than 0';
  }
  const lper100km = 235.214 / mpg;
  return lper100km.toFixed(1); // Rounds up to two decimal places
}
